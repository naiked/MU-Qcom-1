# @file
# Script to Build SM7475 UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("SM7475Pkg",)
    ArchSupported = ("AARCH64",)
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('SM7475', 'gcc_aarch64_linux', 'edk2-build', 'cibuild', 'configdata')
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "SM7475Pkg/SM7475.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "SM7475", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "SM7475Pkg/SM7475.dsc", "Platform Hardcoded")
